    ...
    <div className="min-h-screen pt-24 pb-20 px-6 grid-bg relative">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 text-center">
          <div className="hex-deco mb-4">{"// 0x54454348"}</div>
        ...
        <div className="mb-24">
          ...
          >
            {tech.map((item, i) => (
              <div key={i} className="cyber-tech-icon">
        ...
        {projects.map((category, idx) => {
          ...
          return (
            <div key={idx} className="mb-24">
              <h2 className="category-label text-xl md:text-2xl text-center mb-10 neon-cyan">
                {categoryTitle}
              </h2>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {project.tech.split(", ").map((t, tidx) => (
                            <span key={tidx} className="cyber-pill">{t}</span>
                          ))}
                        </div>
                      </div>
                    </div>
        ...
        <div className="text-center hex-deco py-8">
          {"// EOF — "}{projects.reduce((a, c) => a + c.items.length, 0)}{" PROJECTS LOADED"}
        </div>
      </div>
    </div>
  );
